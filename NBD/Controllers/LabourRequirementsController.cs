...
namespace NBD.Controllers
{
    public class LabourRequirementsController : Controller
    {
        ...
        {
            var nBDContext = _context.LabourRequirements.Include(l => l.Task);
        ...
        {
            if (id != labourRequirement.TeamID)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!LabourRequirementExists(labourRequirement.TeamID))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.LabourRequirements.Any(e => e.TeamID == id);
        }
    }
}
